...
快速分流：**机场主线**改 [`verge/derive/parts/`](verge/derive/parts/) 后按 [`verge/README.md`](verge/README.md) 执行 `compose` / `render-local.sh`；**个人稿**直接维护 `verge/extend/*-rule-split-extend.yaml`。可配合 **`verge/generated/local/override.local`** 与 Hooks。
