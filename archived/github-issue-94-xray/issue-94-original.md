# GitHub Issue #94 原文存档

- **来源**: https://github.com/MyMaskKing/MyMaskKing.github.io/issues/94  
- **标题**: 告别网络高墙：2024最稳Xray Reality科学上网傻瓜式教程_AI转发  
- **作者**: @github-actions[bot]  
- **状态**: open（抓取时）  
- **创建时间**: 2025-09-24T02:02:29Z  
- **标签**: 教程, 科学上网, 翻墙, 网络自由, Xray, VPS, Reality, VLESS, 服务器搭建  

---

以下为 Issue 正文（为便于本地存档自网页整理，结构与原文一致）。
...
1. **注册账号：** 访问 Vultr官网，点击 "Sign Up" 注册账号。需要邮箱验证，并绑定支付方式（支持支付宝、微信支付、PayPal、信用卡等）。
...
在安装任何软件之前，先给系统做个“大扫除”，更新一下软件包列表和已安装的包。
...
* 打开浏览器，访问 Google 或 YouTube。如果能正常访问，恭喜你，你的“秘密通道”已经成功开启！
